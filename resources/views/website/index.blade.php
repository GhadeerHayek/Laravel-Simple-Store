...
<div class="banner_bg_main">
    ...
    <div class="logo_section">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="logo"><a href="index.html"><img src="{{asset('website_assets/images/logo.png')}}"></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="lang_box ">
                        ...
                        <div class="dropdown-menu ">
                            <a href="#" class="dropdown-item">
                                <img src="{{asset('website_assets/images/flag-france.png')}}" class="mr-2" alt="flag">
                                French
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-4">
                                <div class="box_main">
                                    ...
                                    <div class="electronic_img"><img
                                            src="{{asset('website_assets/images/laptop-img.png')}}"></div>
                                    <div class="btn_main">
                                        <div class="buy_bt"><a href="#">Buy Now</a></div>
                                        <div class="seemore_bt"><a href="#">See More</a></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-4">
                                <div class="box_main">
                                    ...
                                    <p class="price_text">Start Price <span style="color: #262626;">$ 100</span></p>
                                    <div class="electronic_img"><img
                                            src="{{asset('website_assets/images/mobile-img.png')}}"></div>
                                    <div class="btn_main">
                                        <div class="buy_bt"><a href="#">Buy Now</a></div>
                                        <div class="seemore_bt"><a href="#">See More</a></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-4">
                                <div class="box_main">
                                    ...
                                    <p class="price_text">Start Price <span style="color: #262626;">$ 100</span></p>
                                    <div class="electronic_img"><img
                                            src="{{asset('website_assets/images/computer-img.png')}}"></div>
                                    <div class="btn_main">
                                        <div class="buy_bt"><a href="#">Buy Now</a></div>
                                        <div class="seemore_bt"><a href="#">See More</a></div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-4">
                                <div class="box_main">
                                    ...
                                    <div class="jewellery_img"><img
                                            src="{{asset('website_assets/images/jhumka-img.png')}}"></div>
                                    <div class="btn_main">
                                        <div class="buy_bt"><a href="#">Buy Now</a></div>
                                        <div class="seemore_bt"><a href="#">See More</a></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-4">
                                <div class="box_main">
                                    ...
                                    <p class="price_text">Start Price <span style="color: #262626;">$ 100</span></p>
                                    <div class="jewellery_img"><img
                                            src="{{asset('website_assets/images/neklesh-img.png')}}"></div>
                                    <div class="btn_main">
                                        <div class="buy_bt"><a href="#">Buy Now</a></div>
                                        <div class="seemore_bt"><a href="#">See More</a></div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-4">
                                <div class="box_main">
                                    ...
                                    <p class="price_text">Start Price <span style="color: #262626;">$ 100</span></p>
                                    <div class="jewellery_img"><img
                                            src="{{asset('website_assets/images/kangan-img.png')}}"></div>
                                    <div class="btn_main">
                                        <div class="buy_bt"><a href="#">Buy Now</a></div>
                                        <div class="seemore_bt"><a href="#">See More</a></div>
                                    </div>
...
<div class="footer_section layout_padding">
    <div class="container">
        <div class="footer_logo"><a href="index.html"><img src="{{asset('website_assets/images/footer-logo.png')}}"></a>
        </div>
        <div class="input_bt">
